...
#define USEC 1000000
#ifdef _SMP_
#define NUM_GUESTS_STATIC       2//4
#define NUM_VCPU_STATIC         2
#else
#define NUM_GUESTS_STATIC       2
#endif
#define NUM_GUESTS_CPU0_STATIC       1//2
#define NUM_GUESTS_CPU1_STATIC       1//2
#define NUM_CPUS       2
...
#define CFG_MEMMAP_GUEST0_OFFSET    0x80000000
#define CFG_MEMMAP_GUEST1_OFFSET   0xC0000000
#define CFG_MEMMAP_GUEST2_OFFSET   0xD0000000
#define CFG_MEMMAP_GUEST3_OFFSET   0xE0000000
#define CFG_GUEST_START_ADDRESS    0x80000000

#define SHARED_ADDRESS (CFG_MEMMAP_GUEST1_OFFSET + 0xEC00000)
#define SHARED_VMID (CFG_MEMMAP_GUEST1_OFFSET + 0xEC000A0)
