...
void TaskStart(void *data)
{
    ...
    OSTaskCreate(MotorFlagControlTask, (void *) 0,
            &MotorFlagControlTaskStk[TASK_STK_SIZE - 1], 10);
    OSTaskCreate(MotorRailControlTask, (void *) 0,
            &MotorRailControlTaskStk[TASK_STK_SIZE - 1], 8);
    OSTaskCreate(MotorLockControlTask, (void *) 0,
            &MotorLockControlTaskStk[TASK_STK_SIZE - 1], 9);
