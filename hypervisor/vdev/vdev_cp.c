...
static int32_t vdev_cp_read(struct arch_vdev_info *info,
...
static int32_t vdev_cp_write(struct arch_vdev_info *info,
                        struct arch_regs *regs)
{
    unsigned int ec = info->ec;
    unsigned int hsr = read_hsr();
...
static int32_t vdev_cp_check(struct arch_vdev_info *info,
                        struct arch_regs *regs)
{
    uint32_t ec = info->ec;
