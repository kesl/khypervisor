...
#define GUEST_SIZE_MAX      0x80000000
...
#define CFG_MEMMAP_PHYS_SIZE       0x200000000
#define CFG_MEMMAP_DEV_AREA        0x80000000
#define CFG_MEMMAP_PHYS_END        (CFG_MEMMAP_PHYS_START+CFG_MEMMAP_PHYS_SIZE-1)
#define CFG_MEMMAP_MON_OFFSET      CFG_MEMMAP_PHYS_START + 0x1E0000000
#define CFG_MEMMAP_GUEST_SIZE      SZ_2G
#define CFG_MEMMAP_GUEST0_OFFSET   CFG_MEMMAP_PHYS_START + (CFG_MEMMAP_GUEST_SIZE * 0)
#define CFG_MEMMAP_GUEST1_OFFSET   CFG_MEMMAP_PHYS_START + (CFG_MEMMAP_GUEST_SIZE * 1)
#define CFG_MEMMAP_GUEST2_OFFSET   CFG_MEMMAP_PHYS_START + (CFG_MEMMAP_GUEST_SIZE * 2)
#define CFG_MEMMAP_GUEST3_OFFSET   CFG_MEMMAP_PHYS_START + (CFG_MEMMAP_GUEST_SIZE * 3)
