...
volatile unsigned int *base_clean = (unsigned int *) (VDEV_MONITORING_BASE + 0x4);
volatile unsigned int *base_list =  (unsigned int *) (VDEV_MONITORING_BASE + 0x8);
volatile unsigned int *base_break = (unsigned int *) (VDEV_MONITORING_BASE + 0xC);
volatile unsigned int *base_go =    (unsigned int *) (VDEV_MONITORING_BASE + 0x10);
volatile unsigned int *base_break_clean = (unsigned int *) (VDEV_MONITORING_BASE + 0x14);
...
static void monitoring_clean(char **argv, int argc)
{
    ...
    uart_print_hex32(va);uart_print("\n");
    *base_clean = va;
}
...
static enum monitoring_cmd_type get_monitoring_cmd(char *input_cmd, char **argv, int *p_argc)
{
