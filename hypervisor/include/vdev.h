...
struct vdev_ops {
     ...
     */
    int32_t (*check)(struct arch_vdev_info *, struct arch_regs *);

    /** Read a virtual register */
    int32_t (*read)(struct arch_vdev_info *, struct arch_regs *);

    /** Write a virtual register */
    int32_t (*write)(struct arch_vdev_info *, struct arch_regs *);
    ...
    hvmm_status_t (*post)(struct arch_vdev_info *, struct arch_regs *);
...
int32_t vdev_search(int level, struct arch_vdev_info *info,
        struct arch_regs *regs);
int32_t vdev_read(int level, int num, struct arch_vdev_info *info,
            struct arch_regs *regs);
int32_t vdev_write(int level, int num, struct arch_vdev_info *info,
            struct arch_regs *regs);
hvmm_status_t vdev_post(int level, int num, struct arch_vdev_info *info,
            struct arch_regs *regs);
