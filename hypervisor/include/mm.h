...
#include "lpae.h"
/**
 * @brief Configure the Memory management features.
 *
 ...
 *     - T0SZ is zero.
 *   - \ref HTCR
 * - Configure Hyper System Control Register(HSCTLR).
 *   - i-cache and alignment checking enable.
 *   - mmu, d-cache, write-implies-xn, low-latency, IRQs disable.
 *   - \ref SCTLR
 * - Configure Hyp Translation Table Base Register(HTTBR).
...
/**
 * @brief Unmapping level3 table entry in virtual address.
 *
