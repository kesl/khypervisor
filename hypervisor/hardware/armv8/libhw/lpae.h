...
union lpaed lpaed_host_l2_block(uint64_t pa,
                enum memattr mattr);
/**
 * @brief Level 0, each entry refer level1 page table
 *
 * Generates a new level 0 LPAE table descriptor refers level 1 page table.
 * It returns the descriptor after generating.
 *
 * - Initial configuration
 *   - Valid and table.
 ...
 *   - physical address = pa
 *
 * @param pa Physical address Refers level1 page table.
 * @return Generated level 0 page table LPAE descriptor.
 */
