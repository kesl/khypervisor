...
static vtimer_callback_t _callback[GENERIC_TIMER_NUM_TYPES];
...
hvmm_status_t generic_timer_set_callback(vtimer_callback_t callback,
                void *user)
{
    HVMM_TRACE_ENTER();
